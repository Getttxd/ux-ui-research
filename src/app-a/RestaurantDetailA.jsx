...
import MenuItemDetailA from './MenuItemDetailA'
import OrderSummaryA from './OrderSummaryA'
import OrderStatusA from './OrderStatusA'

export default function RestaurantDetailA({ 
  restaurant,
  cart: parentCart, 
    ...
    <div className="w-full sm:max-w-[420px] mx-auto bg-white min-h-screen sm:min-h-[880px] sm:max-h-[920px] sm:rounded-[44px] sm:shadow-2xl sm:border-[8px] sm:border-slate-800 flex flex-col relative overflow-hidden text-slate-900 select-none">
      ...
      <div className="flex-1 overflow-y-auto pb-28 scrollbar-none">
        ...
        <div className="p-4">
          ...
          <div className="flex items-center gap-1 text-sm font-bold text-slate-900 mt-1.5">
